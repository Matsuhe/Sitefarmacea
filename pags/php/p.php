...
<div class="content-post">
            ...
            <?php
              $linkimg =  $dados['imagem'];
              
              if(strcmp($linkimg, 'images/uploads/') != 0){
            ?>
                <img src="<?php echo $linkimg;?>" width="200" height="200" class="img-fluid">
            <?php 
              }
            ?>
            <div class="post">
            ...
            <div class="infos">
              ...
              <i class='fas fa-tag'></i> <span class='badge badge-primary'><?php echo($dados['subcategoria']);?></span> |
              <i class='fas fa-tag'></i> <span class='badge badge-success'><?php echo($dados['categoria']);?></span> |
              <i class='fas fa-tag'></i> <span class='badge badge-danger'><?php echo($dados['doenca']);?></span> |
