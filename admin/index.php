...
<html lang="pt-br">
      ...
      <div class="col-sm-4">
        <div class="menu">
          ...
          <ul>
            ...
            <li class="cyan2"><a href="admin/" class="category"> Doenças</a>
              <ul>
                <li><a href="admin/gerenciar-doencas"><i class="fas fa-bars"></i> Gerenciar Doenças</a></li>
              </ul>
            </li>
            ...
            <li class="cyan2"><a href="admin/" class="category">Subcategorias</a>
              <ul>
                <li><a href="admin/gerenciar-subcategorias"><i class="fas fa-bars"></i> Gerenciar Subcategorias</a></li>
              </ul>
            </li>

            <li class="cyan"><a href="admin/" class="category"> Comentarios</a>
              <ul>
                <li><a href="admin/gerenciar-comentarios"><i class="fas fa-bars"></i> Gerenciar Comentarios</a></li>
              </ul>
            </li>
  ...
  <footer><?php echo titulo_site;?> &copy; Criado para <b>Unifesp</b></footer>
